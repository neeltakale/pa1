...
def start_client():
    ...
    socket.SOCK_STREAM)
    client_socket1.connect(('127.0.0.1', 9002)) # Connect to the localhost server at port 9999
    client_socket = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
    client_socket.connect(('127.0.0.1', 9003)) # specify host (itself) and port number 9999
